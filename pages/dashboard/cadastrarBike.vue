...
const salvar = async () => {
    ...
    // dadosBike.preco = String(numero);
    // console.log(dadosBike.preco);
...
if (error) {
    console.log('NAO ATUALIZOU' + error.code);
...
<div class="p-2 bg-emerald-400 h-screen">
  ...
  <div class="flex justify-center items-center">
    ...
    <div class="w-80 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <Form @submit="salvar" :validation-schema="validarDadosBike" class="flex flex-col items-center pb-10">
      
     
            <div>
            <label for="tipoFile">
                <input id="tipoFile" @change="imagemBase64" type="file"   alt="Fotos"/>
                <img :src="previewImagem" class="mt-4 w-24 h-24 mb-3 rounded-full shadow-lg object-cover"/>
            ...
            <div class="flex mt-4 space-x-3 md:mt-6" >
                <div >
                    ...
                    <Field name="modalidadeBike" v-model="dadosBike.modalidade"  type="text" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-2" placeholder="Modalidade" required></Field>
            ...
            <div class="flex mt-4 space-x-3 md:mt-6">
                <button class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >Salvar</button>
            ...
            <p v-if="alertSuccess" name="email" class=" mt-2 p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400">Cadastro realizado com sucesso</p>
